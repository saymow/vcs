...
func TestInvalidRestore(t *testing.T) {
	...
	testifyAssert.EqualError(t, repository.Restore("", "."), "Validation Error: invalid ref.")
	testifyAssert.EqualError(t, repository.Restore("def invalid", "."), "Validation Error: invalid ref.")
	testifyAssert.EqualError(t, repository.Restore("___", "."), "Validation Error: invalid ref.")

	testifyAssert.EqualError(t, repository.Restore("HEAD", "def-invalid-folder"), "Validation Error: invalid path.")
	testifyAssert.EqualError(t, repository.Restore("HEAD", "def-invalid-folder"), "Validation Error: invalid path.")
	testifyAssert.EqualError(t, repository.Restore("HEAD", "def-invalid-folder"), "Validation Error: invalid path.")
}
...
func TestInvalidLoad(t *testing.T) {
	...
	testifyAssert.EqualError(t, repository.Load(""), "Validation Error: invalid ref.")
	testifyAssert.EqualError(t, repository.Load("____"), "Validation Error: invalid ref.")
	testifyAssert.EqualError(t, repository.Load("invalid"), "Validation Error: invalid ref.")
	...
	testifyAssert.EqualError(t, repository.Load("9a35bd416196f27e40f4f9e4768496ef29c1922f0ab5e2651a218e4d4cb09688"), "Validation Error: unsaved changes.")
}
...
func TestLoad(t *testing.T) {
	...
	// Load Save 0
	{
		...
		testifyAssert.Equal(t, repository.head, save0.Id)
		testifyAssert.True(t, repository.isDetachedMode())
		assert.Assert(
			t,
			fs.Equal(
				dir.Path(),
	...
	// Load Save 1
	{
		...
		testifyAssert.Equal(t, repository.head, save1.Id)
		testifyAssert.True(t, repository.isDetachedMode())
		assert.Assert(
			t,
			fs.Equal(
	...
	// Load Save 2
	{
		...
		testifyAssert.Equal(t, repository.head, save2.Id)
		testifyAssert.True(t, repository.isDetachedMode())
		assert.Assert(
			t,
			fs.Equal(
	...
	// Load Save 3 (using ref)
	{
		...
		repository = GetRepository(dir.Path())
		repository.Load(filesystem.INITAL_REF_NAME)

		testifyAssert.Equal(t, repository.head, filesystem.INITAL_REF_NAME)
		testifyAssert.False(t, repository.isDetachedMode())
		assert.Assert(
			t,
			fs.Equal(
				dir.Path(),
